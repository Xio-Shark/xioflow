...
`.xioflow/workflow.md` is the Trellis workflow source of truth inside the user project. An AI does not need Trellis source code to understand how the current project should move tasks forward; this file is enough.

## File Responsibilities

`.xioflow/workflow.md` has three responsibilities:
...
After editing, make the AI reread `.xioflow/workflow.md`; do not assume the flow from the old conversation is still valid.
