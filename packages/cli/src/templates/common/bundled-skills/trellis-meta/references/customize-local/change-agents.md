...
2. `.xioflow/workflow.md` Phase 2 / research routing
...
2. **Do not hard-code project specs into agents**: long-term specs belong in `.xioflow/spec/`; agents are responsible for reading them.
