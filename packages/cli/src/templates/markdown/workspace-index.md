...
```bash
python3 ./.xioflow/scripts/init_developer.py <your-name>
```
...
1. Get your developer name:
   ```bash
   python3 ./.xioflow/scripts/get_developer.py
   ```

2. Read your personal index:
   ```bash
   cat .xioflow/workspace/$(python3 ./.xioflow/scripts/get_developer.py)/index.md
   ```
