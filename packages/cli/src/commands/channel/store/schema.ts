 ...
 *
 * Canonical source: `@xioflow/core/channel`. This module is
...
import { buildContextEntries } from "@xioflow/core/channel";
import type { ContextEntry } from "@xioflow/core/channel";
